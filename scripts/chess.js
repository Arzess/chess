...
'</g>',
'</svg>'];
let darkRookSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45" >',
...
'</g>',
'</svg>'];
let darkBishopSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45" >',
...
'</g>',
'</svg>'];
let darkPawnSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45"">',
...
'</svg>'];
let darkQueenSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45" >', '<g style="fill:#000000;stroke:#000000;stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round">','<path d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z" style="stroke-linecap:butt;fill:#000000"/>','<path d="m 9,26 c 0,2 1.5,2 2.5,4 1,1.5 1,1 0.5,3.5 -1.5,1 -1,2.5 -1,2.5 -1.5,1.5 0,2.5 0,2.5 6.5,1 16.5,1 23,0 0,0 1.5,-1 0,-2.5 0,0 0.5,-1.5 -1,-2.5 -0.5,-2.5 -0.5,-2 0.5,-3.5 1,-2 2.5,-2 2.5,-4 -8.5,-1.5 -18.5,-1.5 -27,0 z"/>',  '<path d="M 11.5,30 C 15,29 30,29 33.5,30"/>',  '<path d="m 12,33.5 c 6,-1 15,-1 21,0"/>',  '<circle cx="6" cy="12" r="2"/>', '<circle cx="14" cy="9" r="2"/>','<circle cx="22.5" cy="8" r="2"/>','<circle cx="31" cy="9" r="2"/>','<circle cx="39" cy="12" r="2"/>','<path d="M 11,38.5 A 35,35 1 0 0 34,38.5" style="fill:none; stroke:#000000;stroke-linecap:butt;"/>','<g style="fill:none; stroke:#ffffff;">','<path d="M 11,29 A 35,35 1 0 1 34,29"/>','<path d="M 12.5,31.5 L 32.5,31.5"/>','<path d="M 11.5,34.5 A 35,35 1 0 0 33.5,34.5"/>','<path d="M 10.5,37.5 A 35,35 1 0 0 34.5,37.5"/>',
  '</g>',
'</g>',
'</svg>'];
let whiteKingSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" ">','<g fill="none" fill-rule="evenodd" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">','<path stroke-linejoin="miter" d="M22.5 11.63V6M20 8h5"/>','<path fill="#fff" stroke-linecap="butt" stroke-linejoin="miter" d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5"/>','<path fill="#fff" d="M12.5 37c5.5 3.5 14.5 3.5 20 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-2.5-7.5-12-10.5-16-4-3 6 6 10.5 6 10.5v7"/>','<path d="M12.5 30c5.5-3 14.5-3 20 0m-20 3.5c5.5-3 14.5-3 20 0m-20 3.5c5.5-3 14.5-3 20 0"/>','</g>','</svg>']
let whiteKnightSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45" >',
'<g style="opacity:1; fill:none; fill-opacity:1; fill-rule:evenodd; stroke:#000000; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(0,0.3)">',
...
'</g>',
'</svg>'];
let whiteRookSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45" >',
...
'</g>',
'</svg>'];
let whiteQueenSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45" >',
...
'</g>',
'</svg>'];
let whitePawnSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45" >',
...
'</svg>'];
let whiteBishopSvgFile = ['<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="45" height="45" >',
'<g style="opacity:1; fill:none; fill-rule:evenodd; fill-opacity:1; stroke:#000000; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:round; stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;" transform="translate(0,0.6)">',
...
'</g>',
'</svg>'];
// Classes of the dark pieces
var darkKnight = {
    color: "dark",
    id: ["dKnight1", "dKnight2"],
    // movingPattern: knightMove(),
    svg: darkKnightSvgFile.join(""),
    isTaken: false,
    quentity: 2,
    initPos: ["b8", "g8"]
}
var darkRook = {
    color: "dark",
    svg: darkRookSvgFile.join(""),
    id: ["dRook1", "dRook2"],
    // movingPattern: rookMove(),
    isTaken: false,
    quentity: 2,
    initPos: ["a8", "h8"]
}
var darkKing = {
    color: "dark",
    svg: darkKingSvgFile.join(""),
    id: ["dKing"],
    // movingPattern: kingMove(),
    isTaken: false,
    initPos: ["e8"],
    quentity: 1
}
var darkQueen = {
    color: "dark",
    svg: darkQueenSvgFile.join(""),
    id: ["dQueen"],
    // movingPattern: queenMove(),
    isTaken: false,
    quentity: 1,
    initPos: ["d8"]
}
var darkBishop = {
    color: "dark",
    svg: darkBishopSvgFile.join(""),
    id: ["dBishop1", "dBishop2"],
    // movingPattern: bishopMove(),
    isTaken: false,
    quentity: 2,
    initPos: ["c8", "f8"]
}
var darkPawn = {
    color: "dark",
    svg: darkPawnSvgFile.join(""),
    id: ["dPawn1", "dPawn2", "dPawn3", "dPawn4", "dPawn5", "dPawn6", "dPawn7", "dPawn8"],
    // movingPattern: pawnMove(),
    isTaken: false,
    quentity: 8,
    initPos: ["a7", "b7", "c7", "d7", "e7", "f7", "g7", "h7"]
}
// Classes of the white pieces
var whiteKnight = {
    color: "white",
    id: ["wKnight1", "wKnight2"],
    // movingPattern: knightMove(),
    isTaken: false,
    svg: whiteKnightSvgFile.join(""),
    quentity: 2,
    initPos: ["b1", "g1"]
}
var whiteRook = {
...
var whiteBishop = {
    color: "white",
    id: ["wBishop1", "wBishop2"],
    // movingPattern: bishopMove(),
    svg: whiteBishopSvgFile.join(""),
    isTaken: false,
    quentity: 2,
    initPos: ["c1", "f1"]
}
var whitePawn = {
    color: "white",
    id: ["wPawn1", "wPawn2", "wPawn3", "wPawn4", "wPawn5", "wPawn6", "wPawn7", "wPawn8"],
    // movingPattern: pawnMove(),
    isTaken: false,
    svg: whitePawnSvgFile.join(""),
    quentity: 8,
    initPos: ["a2", "b2", "c2", "d2", "e2", "f2", "g2", "h2"]

}
function placePieces(){
    let piecesList = [darkKing, whiteKing, darkQueen, whiteQueen, darkKnight, whiteKnight, darkBishop, whiteBishop, darkRook, whiteRook, darkPawn, whitePawn];
    // This cycle is finding and placing pieces to its initial position
    for (let i = 0; i < piecesList.length; i++){
        let getPos = new Array();
        let getColor = new Array();
        let svgFile = piecesList[i].svg;
        // Defines color
        color = piecesList[i].color;
        getColor.push(color);
        // This cycle is all about finding position of the piece
        for(let ii=0; ii<piecesList[i].quentity; ii++){
            // Defines position
            pos = piecesList[i].initPos[ii];
            getPos.push(pos);
        }
        for(let iii = 0; iii<getPos.length; iii++){
            cellToPut = document.getElementById(getPos[iii]);
            cellToPut.innerHTML = `<div class="piece ${getColor[0]}" draggable="true">${svgFile}</div>`;
        }
    }
}
function play(){
  ...
  // It tells whether it is over a chess cell
  chessCell.forEach(cell => {
    ...
    else if (cell.childNodes.length == 1 && selected.classList[1] != cell.childNodes[0].classList[1]){
      e.preventDefault()
    }
    })
  })
